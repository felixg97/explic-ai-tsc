...
Wiki
More
perturb_explanations/code/caffe/python/optimize_mask.py /
@ruthcfong
ruthcfong updated files from rebuttal
Latest commit c768de5 on 15 Jun 2017
 History
 1 contributor
862 lines (761 sloc)  35 KB
...
def optimize_mask(net, path, target, labels, given_gradient = False, norm_score = False, num_iters = 300, lr = 1e-1, l1_lambda = 1e-4, 
    ...
    ########### optimizes for different perturations ###########
    ########### blur
    if null_type == 'blur':
